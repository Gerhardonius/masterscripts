...
# RootTools
import RootTools #just needed for absolut path of package
...
#    ROOT.gROOT.LoadMacro("$CMSSW_BASE/src/RootTools/plot/scripts/tdrstyle.C")
    # almost fixed it
#    ROOT.gROOT.LoadMacro( os.path.join( os.path.abspath(RootTools.__file__).strip('/__init__.pyc'), 'plot/scripts/tdrstyle.C' ) )
    ROOT.gROOT.LoadMacro( '/users/gerhard.ungersbaeck/masterscripts/lib/RootTools/plot/scripts/tdrstyle.C' ) 
    ROOT.setTDRStyle()
...
def draw2D(plot, \
    ...
    # almost fixed it
    #ROOT.gROOT.LoadMacro( os.path.join( os.path.abspath(RootTools.__file__).strip('/__init__.pyc'), 'plot/scripts/niceColorPalette.C' ) )
    ROOT.gROOT.LoadMacro( '/users/gerhard.ungersbaeck/masterscripts/lib/RootTools/plot/scripts/niceColorPalette.C' ) 
