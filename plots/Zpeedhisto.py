...
argParser.add_argument('--plot_directory',     action='store',      default='Zpeedhistos_test')
...
#RatioRatio
ratioratiodef =  {	'histos': [[(1,0),(1,0)],[(3,2),(1,0)]], # draw order is reversed
   			'logY':  False,
			'style': ratiostyles_observed, #my change: function or list of functions (take histo as argument)
