...
# directories
#
flatttreedir = os.path.join( flattreedir, args.subdir)

plot_directory = os.path.join( plotdir, args.subdir)
...
samples = [ Sample.fromFiles("", "/mnt/hephy/pheno/gerhard/Flattree/vtest/SMtest.root" ) ]
...
read_variables = [ "l1_pt/F", "weight/F"]
#read_variables = [
...
plots.append(Plot( name = "l1(pT)",
  texX = 'l1_{T} (GeV)', texY = 'Number of Events / 20 GeV',
