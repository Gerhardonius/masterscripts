...
argParser.add_argument('--flavor',      action='store',      	default='elec', nargs='?', choices=['elec', 'muon'], help="Log level for logging")
...
if args.flavor == 'elec':
	samples = [ SM_DYjets_dielec, BSM_DYjets_dielec ] 
if args.flavor == 'muon':
	samples = [ SM_DYjets_dimuon, BSM_DYjets_dimuon ] 
